package com.gcl.web.controller;
...
public class CounctryController {

    private static final Logger logger = Logger.getLogger(CounctryController.class);
    @Autowired
    private CountryService countryService;

    @RequestMapping
    public ModelAndView getAll(Country country) {
        logger.info("CounctryController begin");
